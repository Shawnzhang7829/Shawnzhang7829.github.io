...
- <strong>Zhang S</strong>, Wu X, Xu P, Liu N*, Li N*. (2026). Local UHI mitigation and utilization: Urban building energy modeling, simulation, and urban design responses based on localized weather data. <strong>Building Simulation</strong>. (SCI Q1, IF=5.9) [[Paper]](https://doi.org/10.1007/s12273-026-1410-7)
...
- Xu P†, Zhao P†, Xia B, Zhao Z, Liu N*, <strong>Zhang S*</strong>, Du J*. (2025). Reciprocal frame design for large-scale timber construction. <strong>Nature communications</strong>. (SCI Q1, IF=15.7) [[Paper]](https://doi.org/10.1038/s41467-025-66491-4)
